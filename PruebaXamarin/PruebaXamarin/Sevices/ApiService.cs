namespace PruebaXamarin.Sevices
{
    using Models;
    ...
    {
        //revisa si hay conexion o no
        public async Task<Response> CheckConnection()
        {
            //CrossConnectivity es un metodo estatico de Current
            //este pregunta si está conectado o no
        ...
        //este metodo devuelve una respuesta
            ...
            string controller)
        {
            try
            {
                ...
                // si generó error devuelve false y el mensaje de error
                if (!response.IsSuccessStatusCode)
                {
                    return new Response
                    {
